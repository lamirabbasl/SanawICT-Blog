...
function ProfileArticle() {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-6 w-5/6">
      <div className="flex flex-col pt-3 w-[400px] text-right overflow-auto h-[320px] custom-scrollbar">
